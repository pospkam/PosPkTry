...
export const PartyIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 15.5a2.5 2.5 0 01-2.5 2.5h-15A2.5 2.5 0 011 15.5v-7A2.5 2.5 0 013.5 6h15A2.5 2.5 0 0121 8.5m-15 0v7m7.5-7v7m-7.5 0h15" />
  </svg>
);
