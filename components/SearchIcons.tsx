// SVG Icons for Premium Search Bar
...
export const PawIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M9 18a5 5 0 0 0 6 0"/>
  </svg>
);

export const FishIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const HelicopterIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M3 10h11"/>
    <path d="M3 14h3"/>
    <path d="M14 14h3"/>
    <path d="M7 18h10"/>
    <path d="M18 10a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v4a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-4Z"/>
    <path d="M18 6h4"/>
  </svg>
);
...
export const HotelIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M2 12v-4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4"/>
    <path d="M18 12h4"/>
    <path d="M2 20h20"/>
  </svg>
);
