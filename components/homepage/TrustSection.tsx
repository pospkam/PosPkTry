...
const TRUST_ITEMS = [
  {
    ...
    desc: 'Все операторы прошли верификацию. Лицензии, страховки, реальные отзывы.',
  },
  {
    icon: MapPin,
    title: 'Карта маршрутов',
    desc: 'Более 1000 мест на интерактивной карте — вулканы, источники, рыболовные реки.',
  },
  {
    icon: Users,
    title: 'Поддержка 24/7',
    desc: 'Экстренная связь с МЧС, AI-помощник и живые координаторы всегда на связи.',
  },
];
