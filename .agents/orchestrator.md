...
| 3. AI Integration Specialist  | LLM-промпты, RAG, tool calling, GROQ/DeepSeek/Grok | Grok-4.2 / DeepSeek R1            | Поиск туров, чат-бот, генерация описаний           | /lib/ai, prompts/, API-ключи                    |
...
4. **Verification Before Done**
   ...
   - скриншоты / Lessons.md – священный файл
