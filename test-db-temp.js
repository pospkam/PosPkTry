/**
 * Временный скрипт тестирования подключения к PostgreSQL на Timeweb Cloud
 */

const { Pool } = require('pg');

// Установка переменных окружения напрямую
process.env.DATABASE_URL = 'postgresql://gen_user:q;3U+PY7XCz@Br@45.8.96.120:5432/default_db';
...
async function testDatabaseConnection() {
  ...
  try {
    ...
    if (error.code === 'ENOTFOUND') {
      ...
      console.log('   • Проверьте DATABASE_URL');
