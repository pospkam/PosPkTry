...
BEGIN
  ...
  INSERT INTO operator_tours (
    ...
    'Зимняя рыбалка: микижа, хариус, кунжа, голец. Снаряжение включено.',
    'Зимняя рыбалка на реках Камчатки. Виды рыб: микижа, хариус, кунжа, голец. Комфортное размещение на базе, полный комплект зимнего снаряжения.',
  ...
  INSERT INTO operator_tours (
    ...
    'Активный клёв зимой: микижа, хариус, кунжа, голец.',
    'river', 'fishing', 'Рыболовная база «Камчатская Рыбалка»',
