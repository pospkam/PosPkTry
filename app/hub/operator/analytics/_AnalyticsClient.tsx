...
const COMING_SOON = [
  { icon: BarChart3, label: 'Выручка по месяцам' },
  { icon: TrendingUp, label: 'Конверсия и просмотры' },
  { icon: Clock,     label: 'Топ туров по продажам' },
];
  ...
  return (
    <div className="p-6 max-w-2xl">
      ...
      <p className="text-sm text-[var(--text-muted)] mb-8">
        Раздел в разработке — появится после подключения реальных данных о бронированиях.
      </p>
