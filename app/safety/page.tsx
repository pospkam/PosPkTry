...
export default function SafetyPage() {
  return (
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 bg-transparent">
      ...
      <div className="border-2 border-[var(--danger)] rounded-lg p-8 mb-8 bg-[var(--danger)]/5">
        <div className="flex items-center gap-3 mb-4">
          <AlertTriangle className="w-12 h-12 text-[var(--danger)]" />
          <div>
            <h2 className="font-serif text-2xl font-bold text-[var(--text-primary)]">При угрозе жизни</h2>
            <p className="text-[var(--text-secondary)]">Немедленно звоните в МЧС</p>
          </div>
        </div>
        <a
          href="tel:112"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
        {[
          ...
          { number: '103', label: 'Скорая', color: 'text-[var(--ocean)]' },
          ...
          <a
            ...
            className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-4 text-center hover:border-[var(--border-strong)] transition-colors min-h-[44px]"
          >
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-lg p-6 mb-6">
        <h2 className="font-serif text-xl font-bold text-[var(--text-primary)] mb-4 flex items-center gap-2">
          ...
          {[
            ...
            return (
              <li key={rule.text} className="flex items-start gap-3">
                ...
                <span className="text-[var(--text-secondary)]">{rule.text}</span>
              </li>
            );
          })}
        </ul>
