...
export default async function Page() {
  return (
    <div className="relative bg-[var(--bg-primary)] text-[var(--text-primary)] min-h-[100dvh]">
      {/* ═══ Карта — на заднем плане, full screen ═══ */}
      ...
      <div className="relative z-10 flex flex-col min-h-[100dvh]">
        ...
        <main className="flex-1 pb-40">
          ...
          <div className="max-w-7xl mx-auto px-4 mt-16 mb-12">
            <h2 className="text-center font-playfair text-2xl font-bold mb-8 text-[var(--text-primary)] drop-shadow-sm">Почему TourHab</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="group relative p-6 rounded-2xl bg-[var(--bg-card)]/90 backdrop-blur-md border border-[var(--border)] text-center transition-all duration-300 hover:shadow-xl hover:shadow-[var(--accent)]/5 hover:-translate-y-1 hover:border-[var(--accent)]/40">
