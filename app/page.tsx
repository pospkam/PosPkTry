      ...
      <main className="flex-1">
        ...
        <div className="max-w-7xl mx-auto px-4 mt-12 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="group p-5 rounded-xl bg-[var(--bg-card)] border border-[var(--border)] text-center transition-all duration-300 hover:shadow-lg hover:shadow-[var(--accent)]/10 hover:-translate-y-1 hover:border-[var(--accent)]/30">
              <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-[var(--accent)]/10 flex items-center justify-center transition-transform duration-300 group-hover:scale-110 group-hover:bg-[var(--accent)]/20">
              ...
              <p className="text-sm font-semibold text-[var(--text-primary)]">AI-планировщик</p>
              <p className="text-xs text-[var(--text-secondary)] mt-1">Подберёт маршрут по вашим интересам за минуты</p>
            </div>
            <div className="group p-5 rounded-xl bg-[var(--bg-card)] border border-[var(--border)] text-center transition-all duration-300 hover:shadow-lg hover:shadow-[var(--accent)]/10 hover:-translate-y-1 hover:border-[var(--accent)]/30">
              <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-[var(--accent)]/10 flex items-center justify-center transition-transform duration-300 group-hover:scale-110 group-hover:bg-[var(--accent)]/20">
                <svg className="w-6 h-6 text-[var(--accent)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <p className="text-sm font-semibold text-[var(--text-primary)]">Живая карта</p>
              <p className="text-xs text-[var(--text-secondary)] mt-1">260 маршрутов с реальными координатами</p>
            </div>
            <div className="group p-5 rounded-xl bg-[var(--bg-card)] border border-[var(--border)] text-center transition-all duration-300 hover:shadow-lg hover:shadow-[var(--accent)]/10 hover:-translate-y-1 hover:border-[var(--accent)]/30">
              <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-[var(--accent)]/10 flex items-center justify-center transition-transform duration-300 group-hover:scale-110 group-hover:bg-[var(--accent)]/20">
                <svg className="w-6 h-6 text-[var(--accent)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <p className="text-sm font-semibold text-[var(--text-primary)]">Проверенные</p>
              <p className="text-xs text-[var(--text-secondary)] mt-1">Только операторы с реальными отзывами</p>
            </div>
            <div className="group p-5 rounded-xl bg-[var(--bg-card)] border border-[var(--border)] text-center transition-all duration-300 hover:shadow-lg hover:shadow-[var(--accent)]/10 hover:-translate-y-1 hover:border-[var(--accent)]/30">
              <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-[var(--accent)]/10 flex items-center justify-center transition-transform duration-300 group-hover:scale-110 group-hover:bg-[var(--accent)]/20">
                <svg className="w-6 h-6 text-[var(--accent)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <p className="text-sm font-semibold text-[var(--text-primary)]">Безопасность</p>
              <p className="text-xs text-[var(--text-secondary)] mt-1">SOS, погода, актуальные предупреждения</p>
            </div>
          </div>
        </div>
