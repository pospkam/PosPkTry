          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-white/20 shadow-2xl">
            ...
            {currentStep === 1 && (
              <div className="space-y-5">
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">Название компании *</label>
                  <input
                    type="text"
                    required
                    value={formData.name}
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">Подтвердите пароль *</label>
                  <div className="relative">
                    <input
            ...
            {currentStep === 2 && (
              <div className="space-y-5">
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">Адрес</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">Веб-сайт</label>
                  <input
                    type="url"
                ...
                <div>
                  <label className="block text-sm font-medium text-white/90 mb-2">Логотип</label>
                  <div
                    ...
                    className={`border-2 border-dashed rounded-xl p-8 text-center transition-all ${
                      dragActive ? 'border-blue-500 bg-blue-500/10' : 'border-white/20 bg-white/5'
                    }`}
                  >
                    {logoPreview ? (
                      <div className="space-y-4">
                        <img src={logoPreview} alt="Logo" className="w-32 h-32 mx-auto object-cover rounded-xl" />
                        <button
                          type="button"
                          onClick={() => {
                            setLogoPreview('');
                      ...
                      <div>
                        ...
                        <p className="text-white/70 mb-2">Перетащите файл или</p>
                        <label className="inline-block px-6 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg cursor-pointer">
                          Выберите файл
            ...
            {currentStep === 3 && (
              <div className="space-y-5">
                ...
                <p className="text-white/70 mb-6">Выберите одно или несколько</p>
            ...
            <div className="flex gap-3 mt-8">
              {currentStep > 1 && (
                <button
                  type="button"
                  onClick={prevStep}
                  className="flex-1 px-6 py-3 bg-white/10 hover:bg-white/20 border border-white/20 text-white rounded-xl font-medium"
                >
                  Назад
                </button>
              )}
              ...
              {currentStep < 3 ? (
                <button
                  type="button"
                  onClick={nextStep}
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white rounded-xl font-semibold"
                >
                  Далее
                </button>
              ) : (
                <button
                  ...
                  disabled={loading}
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white rounded-xl font-semibold disabled:opacity-50"
                >
