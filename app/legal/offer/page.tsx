      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-[var(--text-secondary)]">
          ...
          <section>
            ...
            <p>
              ООО «Трей» (ОГРН 1254100000175, ИНН 4100053571), осуществляющее деятельность под
              брендом KamchatourHub (далее — Платформа), предлагает юридическим лицам и индивидуальным
          ...
          <section>
            ...
            <p>
              ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ «ТРЕЙ»<br />
              ИНН: 4100053571<br />
              ОГРН: 1254100000175<br />
              КПП: 410001001<br />
              Адрес: 683017, Камчатский край, г. Петропавловск-Камчатский, ул. Дзержинского, д. 2а, кв. 22<br />
