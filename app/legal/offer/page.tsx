      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-[var(--text-secondary)]">
          ...
          <section>
            ...
            <p>
              ООО «ПОС-СЕРВИС» (ОГРН 1114101005952, ИНН 4101147649), осуществляющее деятельность под
          ...
          <section>
            ...
            <p>
              ...
              КПП: 410101001<br />
              Адрес: 683024, Камчатский край, г. Петропавловск-Камчатский, пр-кт 50 лет Октября, д. 17/1<br />
