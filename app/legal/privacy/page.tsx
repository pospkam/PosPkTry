        ...
        <div className="prose prose-invert max-w-none space-y-6 text-[var(--text-secondary)]">
          ...
          <section>
            ...
            <p>
              ...
              и защиты персональных данных пользователей платформы KamchatourHub (далее — Платформа),
              принадлежащей ООО «ПОС-СЕРВИС» (ОГРН 1114101005952, ИНН 4101147649) (далее — Оператор).
            </p>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Персонализации контента — формирования рекомендаций туров на основе истории бронирований и предпочтений пользователя (автоматизированная обработка, ст. 16 152-ФЗ)</li>
              <li>Исполнения требований законодательства РФ</li>
            </ul>
            <p className="mt-4 text-sm text-[var(--text-secondary)]">
              <strong>Об автоматизированной обработке:</strong> Платформа может формировать индивидуальные рекомендации на основе
