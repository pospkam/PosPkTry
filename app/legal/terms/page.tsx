        ...
        <div className="prose prose-invert max-w-none space-y-6 text-[var(--text-secondary)]">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Платформа</strong> — интернет-сервис KamchatourHub (kamhub.ru), принадлежащий ООО «ПОС-СЕРВИС» (ИНН 4101147649, ОГРН 1114101005952)</li>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mt-8 mb-4">3. Регистрация</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mt-8 mb-4">4. Бронирование услуг</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mt-8 mb-4">5. Оплата</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mt-8 mb-4">8. Изменение условий</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mt-8 mb-4">9. Применимое право</h2>
            <p>
